          ...
          <Menu />
            <div className="wrapper">
              ...
              <div className="paragraph leading-8 pt-16 md:px-32 uppercase !text-sm">
                ...
                <div className="border-b-[1px] border-black w-full py-2 flex"><div className="w-1/3">Social Media</div><div className="font-bold"><a href="https://www.instagram.com/megparadowski/" target="_blank">Instagram</a></div></div>
